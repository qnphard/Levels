# Binaural Beats Generation Script - V2 (Fixed Levels)
# Lower background (15%), Higher binaural (25%), Voice stays dominant
...
$outputDir = "C:\Users\Admin\.gemini\antigravity\scratch\Levels\src\assets\audio_enhanced_v2"

# Create directories
New-Item -ItemType Directory -Force -Path $tempDir | Out-Null
New-Item -ItemType Directory -Force -Path $outputDir | Out-Null

# Track configurations: name, background_type, beat_hz, carrier_hz
# UPDATED VOLUMES: bg=0.15, bin=0.25 (much quieter background, audible binaural)
$tracks = @(
...
# FIXED VOLUMES
$bgVol = 0.15   # Background at 15% (was 40-45%)
$binVol = 0.25  # Binaural at 25% (was 15%)
...
Write-Host "`nOriginal voice-only files preserved in: audio_originals"
