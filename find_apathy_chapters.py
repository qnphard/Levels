...
keywords = [
    "Apathy", "Level 50", "CHAPTER 3", "CHAPTER 4", "Hopelessness", "Despair"
]

output_file = r"C:\Users\Admin\.gemini\antigravity\scratch\Levels\apathy_locations.txt"
...
print("Apathy location search complete.")
