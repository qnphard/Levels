...
export const consciousnessLevels: ConsciousnessLevel[] = [
  // HEALING CATEGORY (Below 200 - Moving toward Courage)
  {
    ...
    meditations: ['3', '1', '17'],
    articles: ['shame-unworthy', 'preventing-stress'],
    estimatedTime: 20,
    color: '#FFB5C2',
  ...
  },
  {
    ...
    meditations: ['4', '5'],
    articles: ['guilt-forgiveness', 'breaking-apathy'],
    estimatedTime: 25,
    color: '#FFD6A5',
  ...
  },
  {
    ...
    meditations: ['2', '9'],
    articles: ['breaking-apathy', 'loss-and-abandonment'],
    estimatedTime: 15,
    color: '#A5C9FF',
  ...
  },
  {
    ...
    meditations: ['20', '15'],
    articles: ['loss-and-abandonment', 'preventing-stress'],
    estimatedTime: 30,
    color: '#B5EAEA',
  ...
  },
  {
    ...
    meditations: ['1', '17', '3'],
    articles: ['preventing-stress', 'shame-unworthy'],
    estimatedTime: 25,
    color: '#FFF6A3',
  ...
  },
  {
    ...
    meditations: ['7', '18'],
    articles: ['desire-craving', 'willingness-magic'],
    estimatedTime: 20,
    color: '#FFE7C6',
  ...
  },
  {
    ...
    meditations: ['6', '4'],
    articles: ['anger-fuel', 'pride-vulnerability'],
    estimatedTime: 20,
    color: '#FFD6D6',
  ...
  },
  {
    ...
    meditations: ['10', '8', '5'],
    articles: ['pride-vulnerability', 'spiritual-ego'],
    estimatedTime: 25,
    color: '#FFE3F2',
  ...
  // EMPOWERMENT CATEGORY (200-399 - Power, not force)
  {
    ...
    meditations: ['1', '17', '9'],
    articles: ['article-2', 'spiritual-ego'],
    estimatedTime: 25,
    color: '#D1FAE5',
  ...
  },
  {
    ...
    meditations: ['5', '2'],
    articles: ['neutrality-freedom', 'article-1'],
    estimatedTime: 30,
    color: '#CBD5E1',
  ...
  },
  {
    ...
    meditations: ['9', '14'],
    articles: ['willingness-magic', 'neutrality-freedom'],
    estimatedTime: 25,
    color: '#A7F3D0',
  ...
  },
  {
    ...
    meditations: ['4', '6', '15'],
    articles: ['article-1', 'willingness-magic'],
    estimatedTime: 30,
    color: '#FBCFE8',
  ...
  // SPIRITUAL CATEGORY (500-599 - Heart-centered reality)
  {
    ...
    meditations: ['8', '7'],
    articles: ['article-3', 'reason-limits'],
    estimatedTime: 40,
    color: '#FFE7F5',
