...
export const featuredArticles: Article[] = [
  ...
  {
    id: 'shame-unworthy',
    title: 'You Are Not Your Shame',
    summary: 'Shame says "I am bad". Learn the critical distinction between what you are (Awareness) and what you feel.',
    source: 'Essentials · Shame',
    readingTime: 5,
    stage: 'Notice',
    calibration: 20,
    tags: ['Shame', 'Identity', 'Self-Worth'],
  },
  {
    id: 'guilt-forgiveness',
    title: 'The Burden of Guilt',
    summary: 'Guilt is an attempt to change the past through suffering. True responsibility is about present action, not past penance.',
    source: 'Essentials · Guilt',
    readingTime: 4,
    stage: 'Release',
    calibration: 30,
  ...
  {
    id: 'desire-craving',
    title: 'The Trap of Craving',
    summary: 'Desire promises that happiness comes from "getting". Discover why the relief you feel is actually the cessation of craving.',
    source: 'Field Notes · Level 125',
    readingTime: 6,
    stage: 'Notice',
    calibration: 125,
    tags: ['Desire', 'Craving', 'Happiness'],
  },
  {
    id: 'pride-vulnerability',
    title: 'Vulnerability is Power',
    summary: 'Pride is a defense against shame. Real strength does not need to be defended or proven.',
    source: 'Field Notes · Level 175',
    readingTime: 5,
    stage: 'Release',
    calibration: 175,
    tags: ['Pride', 'Defensiveness', 'Strength'],
  },
];
