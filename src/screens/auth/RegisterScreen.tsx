...
export default function RegisterScreen() {
  ...
  const { signUpEmail, signInWithGoogle, googleSignInAvailable, firebaseConfigured } = useAuth();
  ...
  const onSubmit = async () => {
    ...
    setBusy(true);
    try {
      await signUpEmail(email, password, { staySignedIn });
    } catch (e: unknown) {
...
function getStyles(theme: ReturnType<typeof useThemeColors>) {
  return StyleSheet.create({
    ...
    backText: { color: theme.primary, fontSize: typography.body },
    title: {
