# Binaural Beats Generation Script - V5
# Background: 9%, Binaural: 40%, Plus 30s outro
...
# V5 VOLUMES
$bgVol = 0.09   # Background at 9%
$binVol = 0.40  # Binaural at 40%
$outroDuration = 30  # 30 seconds outro
...
foreach ($track in $tracks) {
    ...
    Remove-Item $bgFile, $binFile, $voicePadFile -Force -ErrorAction SilentlyContinue
}

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "V5 Processing complete!" -ForegroundColor Green
Write-Host "Background: 9%, Binaural: 40%, Outro: 30s"
