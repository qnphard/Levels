...
keywords = [
    "Pride", "Level 175", "Scorn", "Inflation", "Arrogance", "CHAPTER 8", "CHAPTER 9"
]

output_file = r"C:\Users\Admin\.gemini\antigravity\scratch\Levels\pride_locations.txt"
...
print("Pride location search complete.")
